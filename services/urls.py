...
urlpatterns = [
    path('search/', search_view, name='search'),  # URL for search view
    ...
    path('api/categories/<str:platform_name>/', CategoryList.as_view(), name='category-list-by-platform'),
    ...
    path('services/<int:service_id>/', service_detail_ajax, name='service_detail'),
    ...
    path('url-search/', url_search_view, name='url_search'),
